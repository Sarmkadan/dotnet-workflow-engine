...
public static class WorkflowBuilderTestsJsonExtensions
{
    ...
    /// <returns>The deserialized <see cref="WorkflowBuilderTests"/> instance, or null if the JSON is empty.</returns>
    ...
    public static WorkflowBuilderTests? FromJson(string json)
    {
        ...
        return JsonSerializer.Deserialize<WorkflowBuilderTests>(json, _jsonOptions);
    }
